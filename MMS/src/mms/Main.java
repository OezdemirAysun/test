...
public class Main {
				...
				if (enemyWaveBoolean) {
					...
					for (Enemy enemy : enemies) {
						enemyLaserShots.add(new EnemyLaser(enemy.getX()
								+ enemy.getWidtH() / 2 - 11, enemy.getY(), 10,
								20));
					}
	...
	private void fonts() {
		...
		font3.drawString(5, 100, Integer.toString(liveCounter));
	}
...
// // alle anderen inputs auer ESC deaktiviern + sounds;
// //
// // abfragen if(player.getX<0||player.getX>bildschirmbreite und Y dann geht A
// bzw D tasten nimchtmehr
// // + W und S fr getY
// //
// // laserabfrage, damit nicht unendlich laser geschossen werden, wenn
// laser.getY>bildschirmhhe, dann lasershots.delete(laser)
// //
// // Hautpmen bzw. Startmen fehlt auch noch
// //
// // Highscore mach ich noch
// //
// // und fr des komplette level brauchen wir dann zb noch einen Time-Manager
// der nach einer bestimmten Zeit einen Gegner erstellt
// //
// // wir knnen auch noch den speedBoost vom Stern auf den Hintergrund
// hinzufgen, dass es aussieht als ob man schneller fliegt
// /////////////////////////
//
// package mms;
//
